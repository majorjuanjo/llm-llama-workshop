...
```mermaid
graph TD
    A[Llama disponible<br/>en GitHub] --> B{¿Ecosistema de<br/>habilitación existe?}
    B -->|❌ No| C[Permanece<br/>sin adoptar]
    B -->|✅ Sí| D[Adopción<br/>masiva]
    
    C --> E[Sólo 0.5%<br/>de PyMEs usan Llama]
    D --> F[50%+ de PyMEs<br/>podrían beneficiarse]
...
{% content-ref url="fundamentos/" %}
[fundamentos](fundamentos/)
{% endcontent-ref %}

{% content-ref url="casos-de-uso/" %}
